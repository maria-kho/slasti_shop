...
from delivery.views import CourierCreateView, CourierRetrieveUpdateView, OrderCreateView, AssignView, CompleteView

urlpatterns = [
    path('couriers', CourierCreateView.as_view(), name='couriers'),
    path('couriers/<int:courier_id>', CourierRetrieveUpdateView.as_view(), name='courier'),
